...
if __name__ == '__main__':
    target_vendor_id = 0x045e # just an example, change it to the actual vendor_id
    target_usage = hid.get_full_usage_id(0x0001, 0x05) # generic vendor page, usage_id = 2
    # go for it!
